/// <reference path="../../src/majsoul.d.ts" />
...
export const charDef = {
    ...
    sex: 0,
    desc_stature: "180厘米",
    desc_stature_chs: "180厘米",
    desc_stature_en: "180厘米",
    desc_stature_jp: "180厘米",
    desc_birth: "3月3日",
    desc_birth_chs: "3月3日",
    desc_birth_en: "3月3日",
    desc_birth_jp: "3月3日",
    ...
    desc_age_jp: "17",
    desc_bloodtype: "AB",
    desc_bloodtype_chs: "AB",
    desc_bloodtype_en: "AB",
    desc_bloodtype_jp: "AB",
    desc_cv: "12",
    desc_cv_chs: "12",
    desc_cv_en: "12",
    desc_cv_jp: "12",
    desc_hobby: "玩游戏，去漫展",
    desc_hobby_chs: "玩游戏，去漫展",
    desc_hobby_en: "玩游戏，去漫展",
    desc_hobby_jp: "玩游戏，去漫展",
    desc: "七对子能力者。人称大当家，12team创始人。",
    desc_chs: "七对子能力者。人称大当家，12team创始人。",
    desc_en: "七对子能力者。人称大当家，12team创始人。",
    desc_jp: "七对子能力者。人称大当家，12team创始人。",
    skin_lib: [0, 0, 0]
} as CharacterDef;
...
export const voiceDef = [{
    ...
    name: "杠",
    name_chs: "杠",
    name_en: "Kan (Call for Quad)",
    name_jp: "カン",
    words: "杠",
    words_chs: "杠",
    words_en: "Kan (Call for Quad)",
    words_jp: "カン",
    category: 2,
    type: "act_kan",
    level_limit: 0,
    ...
    name: "碰",
    name_chs: "碰",
    name_en: "Pon (Call for Triplet)",
    name_jp: "ポン",
    words: "碰",
    words_chs: "碰",
    words_en: "Pon (Call for Triplet)",
    words_jp: "ポン",
    category: 2,
    type: "act_pon",
    level_limit: 0,
    ...
    name: "拔北",
    name_chs: "拔北",
    name_en: "Replace North",
    name_jp: "北抜き",
    words: "拔北",
    words_chs: "拔北",
    words_en: "Replace North",
    words_jp: "ペー",
    category: 2,
    type: "act_babei",
    level_limit: 0,
    ...
    name: "终局一位语音",
    name_chs: "终局一位语音",
    name_en: "Finishing a game at 1st place",
    name_jp: "清算一位",
    words: "打麻将真开心",
    words_chs: "打麻将真开心",
    words_en: "Finishing a game at 1st place",
    words_jp: "清算一位",
    category: 2,
    type: "game_top",
    level_limit: 1,
    ...
    name: "登录语音普通",
    name_chs: "登录语音普通",
    name_en: "Login Voice - Normal",
    name_jp: "ログイン・普通",
    words: "小伙子今天看直播了吗...",
    words_chs: "小伙子今天看直播了吗...",
    words_en: "小伙子今天看直播了吗...",
    words_jp: "小伙子今天看直播了吗...",
    category: 1,
    ...
    name: "登录语音满羁绊",
    name_chs: "登录语音满羁绊",
    name_en: "Login Voice - Max Bond",
    name_jp: "ログイン・絆LvMAX",
    words: "小伙子再不来看直播老子就失业了...",
    words_chs: "小伙子再不来看直播老子就失业了...",
    words_en: "小伙子再不来看直播老子就失业了...",
    words_jp: "小伙子再不来看直播老子就失业了...",
    category: 1,
    type: "lobby_playerlogin",
    level_limit: 5,
    time_length: 1000,
    ...
    name: "大厅交互语音1",
    name_chs: "大厅交互语音1",
    name_en: "Lobby Interactive Voice 1",
    name_jp: "メイン1",
    words: "草 垃圾游戏",
    words_chs: "草 垃圾游戏",
    words_en: "草 垃圾游戏",
    ...
    name: "大厅交互语音2",
    name_chs: "大厅交互语音2",
    name_en: "Lobby Interactive Voice 2",
    name_jp: "メイン2",
    words: "草 真的没法玩",
    words_chs: "草 真的没法玩",
    words_en: "草 真的没法玩",
    ...
    name: "大厅交互语音3",
    name_chs: "大厅交互语音3",
    name_en: "Lobby Interactive Voice 3",
    name_jp: "メイン3",
    words: "草 好难阿",
    words_chs: "草 好难阿",
    words_en: "草 好难阿",
    ...
    name: "大厅交互语音4",
    name_chs: "大厅交互语音4",
    name_en: "Lobby Interactive Voice 4",
    name_jp: "メイン4",
    words: "草 再不来斗鱼12666看直播老子失业了",
    words_chs: "草 再不来斗鱼12666看直播老子失业了",
    words_en: "草 再不来斗鱼12666看直播老子失业了",
    words_jp: "草 再不来斗鱼12666看直播老子失业了",
    category: 1,
    type: "lobby_normal",
    level_limit: 2,
    time_length: 1000,
    ...
    name: "大厅交互语音5",
    name_chs: "大厅交互语音5",
    name_en: "Lobby Interactive Voice 5",
    name_jp: "メイン5",
    words: "草",
    words_chs: "草",
    words_en: "草",
    ...
    name: "大厅交互语音6",
    name_chs: "大厅交互语音6",
    name_en: "Lobby Interactive Voice 6",
    name_jp: "メイン6",
    words: "LYC是条狗",
    words_chs: "LYC是条狗",
    words_en: "LYC是条狗",
    ...
    name: "大厅交互语音7",
    name_chs: "大厅交互语音7",
    name_en: "Lobby Interactive Voice 7",
    name_jp: "メイン7",
    words: "LYC小脑不发达",
    words_chs: "LYC小脑不发达",
    words_en: "LYC小脑不发达",
    ...
    name: "大厅交互语音8",
    name_chs: "大厅交互语音8",
    name_en: "Lobby Interactive Voice 8",
    name_jp: "メイン8",
    words: "LYC是我最差的一个儿子",
    words_chs: "LYC是我最差的一个儿子",
    words_en: "LYC是我最差的一个儿子",
    words_jp: "LYC是我最差的一个儿子",
    category: 1,
    type: "lobby_normal",
    level_limit: 5,
    time_length: 1000,
    ...
    name: "送礼物语音喜好",
    name_chs: "送礼物语音喜好",
    name_en: "Receiving Gift - Preferred",
    name_jp: "プレゼント・好み",
    words: "谢谢啊！",
    words_chs: "谢谢啊！",
    words_en: "谢谢啊！",
    ...
    name: "好感度升级语音4",
    name_chs: "好感度升级语音4",
    name_en: "Bond Level Up Voice 4",
    name_jp: "絆レベルアップ4",
    words: "嗯...你这个小伙子非常非常可以",
    words_chs: "嗯...你这个小伙子非常非常可以",
    words_en: "嗯...你这个小伙子非常非常可以",
    words_jp: "嗯...你这个小伙子非常非常可以",
    category: 1,
    type: "lobby_levelmax",
    level_limit: 5,
    time_length: 1000,
    ...
    name: "混全带幺九",
    name_chs: "混全带幺九",
    name_en: "Terminal or Honor in Every Group",
    name_jp: "混全帯么九",
    words: "混全带幺九",
    words_chs: "混全带幺九",
    words_en: "混全带幺九",
    ...
    name: "纯全带幺九",
    name_chs: "纯全带幺九",
    name_en: "Terminal in Every Group",
    name_jp: "純全帯么九",
    words: "纯全带幺九",
    words_chs: "纯全带幺九",
    words_en: "纯全带幺九",
    ...
    name: "二杯口",
    name_chs: "二杯口",
    name_en: "Double Double Sequence",
    name_jp: "二盃口",
    words: "二杯口",
    words_chs: "二杯口",
    words_en: "二杯口",
    ...
    name: "四暗刻单骑",
    name_chs: "四暗刻单骑",
    name_en: "Four Concealed Triplets (Single Wait)",
    name_jp: "四暗刻単騎",
    words: "四暗刻单骑",
    words_chs: "四暗刻单骑",
    words_en: "四暗刻单骑",
    ...
    name: "国士无双13面听",
    name_chs: "国士无双13面听",
    name_en: "Thirteen Orphans (Thirteen Waits)",
    name_jp: "国士無双十三面待ち",
    words: "国士无双13面听",
    words_chs: "国士无双13面听",
    words_en: "国士无双13面听",
    ...
    name: "九种九牌",
    name_chs: "九种九牌",
    name_en: "Nine Terminal Initial Draw",
    name_jp: "九種九牌",
    words: "九种九牌",
    words_chs: "九种九牌",
    words_en: "九种九牌",
